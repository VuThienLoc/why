...
export default function ReagentAddModal({
    isOpen,
    onClose,
    onSave,
}: ReagentAddModalProps) {
    ...
    const handleSubmit = async () => {
        ...
        const submitData: Partial<Reagent> = {
            ...
            manufacturer: formData.reagent_type, // Fallback
                    ...
                    >
                        {isSubmitting ? (
                            <div className="flex items-center gap-2">
                                ...
                                <span>{t('reagent.formModal.adding')}</span>
                            </div>
                        ) : (
                            t('reagent.save')
                        )}
